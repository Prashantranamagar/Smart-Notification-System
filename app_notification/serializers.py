...
from .models import (
    Notification, NotificationPreference, NotificationDelivery, EventType,
    NotificationChannel, UserEventPreference
)
...
class UserEventPreferenceSerializer(serializers.ModelSerializer):
    ...
    def validate_event_type_code(self, value):
        ...
        try:
            ...
            raise serializers.ValidationError(f"Event type '{value}' does not exist or is inactive")
        return value
