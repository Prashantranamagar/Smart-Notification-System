...
urlpatterns = [
    ...
    path('event-preferences/', views.UserEventPreferencesView.as_view(), name='user-event-preferences'),
    path('event-preferences/update/', views.update_event_preferences, name='update-event-preferences'),
    ...
    # Admin endpoints
    path('admin/event-types/', views.CreateEventTypeView.as_view(), name='admin-create-event-type'),
]